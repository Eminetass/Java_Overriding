//Çalışan bilgilerini tutan bazı değişkenler ve değer ataması için metot tanımlandı
public class EmployeManager {
    ...
    public void addEmploye(String employeName,String employeSurName,String employeJob,
                           double employeMoney){
